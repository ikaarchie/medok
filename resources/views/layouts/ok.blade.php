...
<div class="container-fluid wrapper mb-3">
    <ul class="nav nav-tabs">
        <li class="nav-item">
            <a class="nav-link {{ Request::is('ok') ? 'active' : '' }}" aria-current="page"
                href="{{ route('monitoringOK') }}">Monitoring</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Request::is('dokter_ok') ? 'active' : '' }}" href="{{ route('dokterOK') }}">Data
                Dokter</a>
        </li>
    </ul>
</div>
