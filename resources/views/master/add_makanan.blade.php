<div class="modal fade" id="tambahmakanan" tabindex="-1" data-bs-backdrop="static" aria-labelledby="modalTambahMakanan"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahMakanan">Tambah Item</h5>
