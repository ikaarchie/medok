    ...
    <div class="table-responsive mt-1 table-data tbl-fixed">
        <table class="table table-bordered border-dark align-middle w-100" id="myTable">
            ...
            <tbody style=" background-color: #F8BBD0">
                ...
                <tr>
                    <td>{{ $master->firstItem() + $key }}</td>
                    <td>{{ $item->item }}</td>
                    <td>{{ $item->jenis }}</td>
                    <td>{{ $item->status }}</td>
                    <td>
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <a href="#edit{{ $item->id }}" data-bs-toggle="modal" class="btn btn-sm btn-warning"><i
                                    class="fa-solid fa-pen-to-square"></i> Edit</a>
                            <a href="#" class="btn btn-sm btn-danger deleteSwal" data-id="{{ $item->id }}"
                                data-nama="{{ $item->item }}"><i class="fa-solid fa-trash"></i> Delete</a>
                            @include('master.edit')
                        </div>
                    </td>
                </tr>
